window.LAZRM_TRANSLATIONS = {
  en: {
    "meta.home.title": "Lazar Minkov — Web Developer in Bern",
    "meta.home.description":
      "Lazar Minkov is a web developer and UI/UX designer in Bern, Switzerland, creating distinctive digital experiences.",
    "meta.blog.title": "Journal — Lazar Minkov",
    "meta.blog.description":
      "Notes on design, development and digital craft by Lazar Minkov, a web developer in Bern.",
    "meta.imprint.title": "Imprint — Lazar Minkov",
    "meta.imprint.description":
      "Imprint and contact information for Lazar Minkov, web developer in Bern, Switzerland.",
    ...
    "common.menu": "Menu",
    "common.close": "Close",
    "common.location": "Bern — CH",
    "common.footerRole": "Web developer / Bern",
    ...
    "home.marquee.motion": "Interaction & motion",
    ...
    "home.about.bio2":
      "My background in customer-facing technology and automotive sales keeps the work practical: clear goals, direct communication and digital products that people can actually use.",
    "home.about.services": "What I do",
    "home.about.service1": "Art direction & UI/UX",
    "home.about.service2": "Front-end & full-stack development",
    "home.about.service3": "Motion & interaction",
    "home.about.service4": "E-commerce & digital products",
    "home.about.facts": "In short",
    "home.about.based": "Based",
    "home.about.basedValue": "Bern, CH",
    "home.about.focus": "Focus",
    "home.about.focusValue": "Web & digital",
    "home.about.credential": "Diploma",
    "home.about.credentialValue": "SAE Webdesign & Development",
    "home.about.available": "Available",
    "home.about.availableValue": "Select projects",
    ...
    "home.background.item2.title": "SAE Diploma",
    "home.background.item2.text":
      "Webdesign & Development — responsive design, accessibility, JavaScript, APIs, back-end fundamentals and usability testing.",
    "home.background.item3.date": "2023 — 2025",
    "home.background.item3.title": "Project Neptun, ETH Zürich",
    "home.background.item3.text":
      "Technical support and customer consultation across Microsoft, HP, Lenovo and Apple hardware.",
    "home.background.item4.date": "2025 — 2026",
    "home.background.item4.title": "Automotive sales & operations",
    ...
    "home.principles.kicker": "Working principles",
    "home.principles.side": "What holds the work together.",
    "home.principles.one.title": "Clarity before decoration.",
    "home.principles.one.text":
      "Every decision should sharpen the story or improve the experience.",
    "home.principles.two.title": "Motion with a reason.",
    "home.principles.two.text":
      "Animation guides attention, gives feedback and creates rhythm — never delay.",
    "home.principles.three.title": "Details that survive launch.",
    "home.principles.three.text":
      "Responsive, accessible, performant and maintainable are part of the design.",

    "home.contact.kicker": "Contact",
    "home.contact.side": "Good work starts with a useful conversation.",
    "home.contact.title": "Let’s make<br /><em>something matter.</em>",
    "home.contact.nameLabel": "Your name",
    "home.contact.namePlaceholder": "Name / Company",
    "home.contact.emailLabel": "Your email",
    "home.contact.emailPlaceholder": "you@company.com",
    ...
    "blog.latestSide": "Open an entry to read.",
    "blog.entry1.title": "Motion that earns its place",
    "blog.entry1.lead":
      "Good motion does not ask to be watched. It helps you understand what changed.",
    "blog.entry1.p1":
      "The strongest interface animation often lives between two states: a menu remembers where it came from, a card keeps its visual position as it opens, or a form confirms an action before the user has time to wonder.",
    "blog.entry1.p2":
    ...
    "blog.entry2.title": "The case for fewer components",
    "blog.entry2.lead":
    ...
    "blog.entry3.title": "The first screen is not a poster",
    "blog.entry3.lead":
    ...
    "blog.endnote": "End note",
    "blog.ctaTitle": "Have a thought<br />worth <em>building?</em>",
    "blog.cta": "Start a<br />conversation",

    "imprint.eyebrow": "Legal / Contact",
    "imprint.title": "Imprint<br /><em>& information.</em>",
    "imprint.intro":
  ...
  de: {
    "meta.home.title": "Lazar Minkov — Webentwickler in Bern",
    "meta.home.description":
      "Lazar Minkov ist Webentwickler und UI/UX Designer in Bern und entwickelt charakterstarke digitale Erlebnisse.",
    "meta.blog.title": "Journal — Lazar Minkov",
    "meta.blog.description":
      "Notizen über Design, Entwicklung und digitales Handwerk von Lazar Minkov, Webentwickler in Bern.",
    "meta.imprint.title": "Impressum — Lazar Minkov",
    "meta.imprint.description":
      "Impressum und Kontaktangaben von Lazar Minkov, Webentwickler in Bern.",

    "common.skip": "Zum Inhalt springen",
    "common.nav.home": "Start",
    "common.nav.about": "Über mich",
    "common.nav.portfolio": "Portfolio",
    "common.nav.contact": "Kontakt",
    "common.nav.blog": "Journal",
    "common.navigation": "Navigation",
    "common.menu": "Menü",
    "common.close": "Schliessen",
    "common.location": "Bern — CH",
    "common.footerRole": "Webentwickler / Bern",
    ...
    "common.theme.switchToLight": "Zum hellen Farbschema wechseln",
    "common.theme.switchToDark": "Zum dunklen Farbschema wechseln",
    ...
    "home.marquee.design": "Design Direction",
    "home.marquee.development": "Creative Development",
    "home.marquee.motion": "Interaktion & Motion",
    ...
    "home.about.bio2":
      "Meine Erfahrung in kundenorientierter Technologie und im Automobilverkauf hält die Arbeit praxisnah: klare Ziele, direkte Kommunikation und digitale Produkte, die Menschen wirklich nutzen können.",
    "home.about.services": "Leistungen",
    "home.about.service1": "Art Direction & UI/UX",
    "home.about.service2": "Front-end & Full-stack Entwicklung",
    "home.about.service3": "Motion & Interaktion",
    "home.about.service4": "E-Commerce & digitale Produkte",
    "home.about.facts": "Kurz gesagt",
    "home.about.based": "Standort",
    "home.about.basedValue": "Bern, CH",
    "home.about.focus": "Fokus",
    "home.about.focusValue": "Web & Digital",
    "home.about.credential": "Diplom",
    "home.about.credentialValue": "SAE Webdesign & Development",
    "home.about.available": "Verfügbar",
    "home.about.availableValue": "Ausgewählte Projekte",
    ...
    "home.background.item2.title": "SAE Diplom",
    "home.background.item2.text":
      "Webdesign & Development — Responsive Design, Barrierefreiheit, JavaScript, APIs, Back-end Grundlagen und Usability Testing.",
    "home.background.item3.date": "2023 — 2025",
    "home.background.item3.title": "Projekt Neptun, ETH Zürich",
    "home.background.item3.text":
      "Technischer Support und Kundenberatung für Geräte von Microsoft, HP, Lenovo und Apple.",
    "home.background.item4.date": "2025 — 2026",
    "home.background.item4.title": "Automobilverkauf & Betrieb",
    "home.background.item4.text":
    ...
    "home.principles.side": "Was die Arbeit zusammenhält.",
    "home.principles.one.title": "Klarheit vor Dekoration.",
    "home.principles.one.text":
      "Jede Entscheidung soll die Geschichte schärfen oder das Erlebnis verbessern.",
    "home.principles.two.title": "Bewegung mit Grund.",
    "home.principles.two.text":
      "Animation lenkt Aufmerksamkeit, gibt Feedback und schafft Rhythmus — ohne aufzuhalten.",
    "home.principles.three.title": "Details, die den Launch überstehen.",
    "home.principles.three.text":
      "Responsive, barrierefrei, performant und wartbar gehören zum Design.",

    "home.contact.kicker": "Kontakt",
    "home.contact.side": "Gute Arbeit beginnt mit einem guten Gespräch.",
    "home.contact.title": "Lass uns etwas<br /><em>Relevantes bauen.</em>",
    "home.contact.nameLabel": "Dein Name",
    "home.contact.namePlaceholder": "Name / Firma",
    "home.contact.emailLabel": "Deine E-Mail",
    "home.contact.emailPlaceholder": "du@firma.ch",
    ...
    "blog.latestSide": "Eintrag öffnen und lesen.",
    "blog.entry1.title": "Motion, die ihren Platz verdient",
    "blog.entry1.lead":
      "Gute Bewegung verlangt nicht, betrachtet zu werden. Sie hilft zu verstehen, was sich verändert hat.",
    "blog.entry1.p1":
      "Die stärkste Interface-Animation lebt oft zwischen zwei Zuständen: Ein Menü erinnert sich an seinen Ursprung, eine Karte behält beim Öffnen ihre visuelle Position oder ein Formular bestätigt eine Aktion, bevor Unsicherheit entsteht.",
    "blog.entry1.p2":
      "Ich beginne mit drei Fragen: Was braucht Aufmerksamkeit? Welche Beziehung wird erklärt? Wie schnell kann sich die Interaktion wieder zurücknehmen? Gibt es keine sinnvolle Antwort, muss sich das Element wahrscheinlich nicht bewegen.",
    "blog.entry2.title": "Warum weniger Komponenten oft mehr sind",
    "blog.entry2.lead":
      "Ein Designsystem ist sinnvoll, wenn es eine Idee schützt — nicht wenn es jedes mögliche Rechteck katalogisiert.",
    "blog.entry2.p1":
      "Zu frühe Abstraktion kann eine klare visuelle Richtung in eine Inventur verwandeln. Ich baue zuerst die echten Seiten, beobachte die belastbaren Muster und extrahiere nur Komponenten, die künftige Entscheidungen reduzieren.",
    "blog.entry2.p2":
      "Das Ergebnis ist meist ein kleineres System mit stärkeren Regeln: eine Typografieskala, ein Rhythmus, wenige räumliche Verhaltensweisen und Komponenten, die ihren Wert bereits im Kontext bewiesen haben.",
    "blog.entry3.title": "Der erste Screen ist kein Poster",
    "blog.entry3.lead":
      "Ein Hero kann expressiv sein und trotzdem erklären, wo man ist, warum es zählt und wie es weitergeht.",
    "blog.entry3.p1":
      "Die Versuchung ist gross, den gesamten Einstieg mit einem maximal grossen Satz zu füllen. Die bessere Aufgabe ist kompositorisch: Charakter und Orientierung, Spannung und Lesereihenfolge, Inszenierung und einen klaren nächsten Schritt auszubalancieren.",
    "blog.entry3.p2":
    ...
    "imprint.title": "Impressum<br /><em>& Informationen.</em>",
    "imprint.intro":
